...
| <a name="input_listener_rule_configuration"></a> [listener\_rule\_configuration](#input\_listener\_rule\_configuration) | Listener rule configuration block | <pre>object({<br>    arn = string<br>    host_header = optional(list(string))<br>    query_string = optional(list(string))<br>  })</pre> | <pre>{<br>  "host_header": null,<br>  "query_string": null<br>}</pre> | no |
